...
router.post(
  ...
  async (req, res, next) => {
    ...
    if (req.file == undefined){
      pizzaImg = "https://img.freepik.com/free-photo/pizza-with-salami-tomatoes-olives-cheese-dough-with-whole-wheat-flour-italian-food_2829-6855.jpg?w=1380&t=st=1667915693~exp=1667916293~hmac=bf0f0ed1b04c6aa61987760ee4c701f5940a2cb342e3582cc2bcdc1f8f8be842"
    }
    else { pizzaImg = req.file.path}
